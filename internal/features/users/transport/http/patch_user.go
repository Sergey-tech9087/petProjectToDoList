...
import (
	...
	core_http_request "github.com/Sergey-tech9087/petProjectToDoList/internal/core/transport/http/request"
	core_http_response "github.com/Sergey-tech9087/petProjectToDoList/internal/core/transport/http/response"
	core_http_types "github.com/Sergey-tech9087/petProjectToDoList/internal/core/transport/http/types"
)

type PatchUserRequest struct {
	FullName    core_http_types.Nullable[string] `json:"full_name" swaggertype:"string" example:"Maximov Maxim Maximovich"`
...
// @Description 	### Логика обновления полей (Tree-state logic):
// @Description 	1. **Поле не передано**: `phone_number` игнорируется, значение в БД не меняется
// @Description 	2. **Явно передано значение**: `"phone_number": "+71112223344"` - устанавливается новый номер
