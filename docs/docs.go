...
const docTemplate = `{
    ...
    "paths": {
        "/statistics": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Фильтрация статисики по конкретному пользователю",
                        "name": "user_id",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Начало промежутка рассмотения статистики",
                        "name": "from",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Конец промежутка рассмотения статистики",
                        "name": "to",
                        "in": "query"
                    }
                ],
                "responses": {
                    ...
                    "400": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/github_com_Sergey-tech9087_petProjectToDoList_internal_core_transport_http_response.ErrorResponse"
                        }
                    },
                    "500": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/internal_features_tasks_transport_http.TasksDTOResponse"
                            }
                        }
                    },
                    "400": {
        ...
        "/tasks/{id}": {
            ...
            "patch": {
                ...
                "responses": {
                    "200": {
                        "description": "Успешное измененная задача",
                        "schema": {
        ...
        "/users/{id}": {
            ...
            "patch": {
                ...
                "responses": {
                    "200": {
                        "description": "Успешное измененный пользователь",
                        "schema": {
    ...
    "definitions": {
        "github_com_Sergey-tech9087_petProjectToDoList_internal_core_transport_http_response.ErrorResponse": {
            "type": "object",
            "properties": {
                "error": {
                    "type": "string",
        ...
        "github_com_Sergey-tech9087_petProjectToDoList_internal_core_transport_http_types.Nullable-bool": {
            "type": "object",
            "properties": {
                "set": {
                    "type": "boolean"
        ...
        "github_com_Sergey-tech9087_petProjectToDoList_internal_core_transport_http_types.Nullable-string": {
            "type": "object",
            "properties": {
                "set": {
                    "type": "boolean"
        ...
        "internal_features_tasks_transport_http.CreateTaskRequest": {
            ...
            "properties": {
                ...
                "description": {
                    ...
                    "maxLength": 1000,
                    "minLength": 1,
                    "example": "Rework pet project add feature"
                },
                "title": {
                    "type": "string",
                    "maxLength": 100,
        ...
        "internal_features_tasks_transport_http.PatchTaskRequest": {
            ...
            "properties": {
                "completed": {
                    "$ref": "#/definitions/github_com_Sergey-tech9087_petProjectToDoList_internal_core_transport_http_types.Nullable-bool"
                },
                "description": {
                    "$ref": "#/definitions/github_com_Sergey-tech9087_petProjectToDoList_internal_core_transport_http_types.Nullable-string"
                },
                "title": {
                    "$ref": "#/definitions/github_com_Sergey-tech9087_petProjectToDoList_internal_core_transport_http_types.Nullable-string"
                }
        ...
        "internal_features_tasks_transport_http.TasksDTOResponse": {
            "type": "object",
            "properties": {
                "author_user_id": {
                    "type": "integer",
        ...
        "internal_features_users_transport_http.PatchUserRequest": {
            ...
            "properties": {
                "full_name": {
                    "type": "string",
                    "example": "Maximov Maxim Maximovich"
                },
                "phone_number": {
                    "type": "string",
                    "example": "+79998887766"
